...
class _AppointmentDashState extends State<AppointmentDash> {
  ...
  final AppointmentsController = Get.put(appointmentController());

  _AppointmentDashState({
    required this.patientName,
    required this.clinicId,
    required this.userId,
    required this.patientId,
          ...
          child: Column(
            ...
            children: [
              ...
              FutureBuilder<Map<String, dynamic>?>(
                future: AppointmentsController.listappointment(
                  patientId,
                  clinicId,
                  userId,
                  startDate,
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Column(
                                      mainAxisAlignment: MainAxisAlignment.end,
                                      children: [
                                        Text(user.result![index].appointmentDate
                                            .toString()),
                                        Card(
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(user.result![index].doctorName
                                        .toString()),
                                    Text(user.result![index].description
                                        .toString()),
                                  ],
                                ),
                              ],
